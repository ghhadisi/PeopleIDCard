...
Java_com_dbgs_peopleidcard_ImageProcess_findIdNumber(jobject src, jobject out, jobject tpl){


}

JNIEXPORT jobject JNICALL
Java_com_dbgs_peopleidcard_ImageProcess_getIdNumber(JNIEnv *env, jclass type, jobject src,
...
//    img_idNumber = img_threshold(rect);
    LOGD("aaaaa");
    LOGE("rect.x=%d, rect.y=%d   rect.width=%d   rect.height= %d ",rect.x,rect.y,rect.width,rect.height);
